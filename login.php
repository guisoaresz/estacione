        ...
        headerTemp();
            ...
            <div class="container-login">
                ...
                <form method="post">
                    ...
                    <input type="text" name="txtUsuario" placeholder="Nome de usuário ou email" required min="4" max="100"><br>
                    <input type="password" name="txtSenha" placeholder="Senha" required max="25"><br>
            ...
            <div class="container-register">
                ...
                <form method="post">
                    ...
                    <input type="text" name="txtUsuario" placeholder="Nome de usuário" required min="4" max="25"><br>
                    <input type="email" name="txtEmail" placeholder="Email" required max="100"><br>
                    <input type="password" name="txtSenha" placeholder="Senha" required min="8" max="25"><br>
